...
window.addEventListener("load",function () {
    ...
    let orderList = [
        ...
        {
            id:5, herf:'service-info.html',src:'./image/shuilongtou.png',name:'高端水龙头',type:'ECC01-001Lw',info:'商品规格潜水艇高端龙头',price:'60',number:'1',statusInfo:'售后服务',blue:'联系客服',green:'查看详情',blueHerf:'../lxywater/kefu.html',greenHerf:'drawback-info.html',status:'after'
        },
